...
layout: PostSimple
# layout: PostLayout
summary: Type unification with examples in Haskell
bibliography: bib/type-unification.bib
# authors: ['default', 'klezm']
---
...
@supports (-moz-appearance:none) {
    /* Prevent linebreak of background-color-div before & after inline equation */
    .equation-inline .katex-mathml {
        display: none;
    }
}
`}
...
<div className="my-toc">
  {/* <TOCInline toc={props.toc} exclude="Validierung" asDisclosure collapse ulClassName="[&_ul]:list-[revert]" /> */}
...
{/* <pre>
    <code class="language-hs code-highlight">
        <span class="code-line prose-td:text-center prose-tr:py-5">
            <table className="my-0">
                ...
                <tr className="text-lg">
                    <td>
                        <span class="token builtin">map</span> <span> </span>
                        <span class="token operator">::</span> <span> </span>
                    </td>
                    <td>
                        <span>
                            <span class="token punctuation">(</span>
                            <span class="token hvariable">a</span> <span> </span>
                            <span class="token operator">-&gt;</span> <span> </span>
                ...
                <tr>
                    <td></td>
                    <td>Function to be applied to each element</td>
                    <td></td>
                    <td>List of elements</td>
                    <td></td>
                    <td>Processed List</td>
                </tr>
            </table>
        </span>
    </code>
...
funciton on each element. Since
...
{/* <div className="bg-black/80 *:my-0 py-1 text-sm font-bold text-center text-gray-500 dark:text-gray-400"> */}
{/* <div className="bg-[document.body.style.backgroundColor] *:my-0 py-1 text-sm font-bold text-center text-gray-500 dark:text-gray-400">
...
{/* The result is a list with the length of the words in the string. */}
...
{/* param urls - An array of arrays, where the 1. element is the URL and the 2. element is the popup text. */}
{/* returns: A JSX element containing the list of citation URLs. */}
