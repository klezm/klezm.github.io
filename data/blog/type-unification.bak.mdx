...
{/_ https://hoogle.haskell.org/?hoogle=map
https://hackage.haskell.org/package/base-4.20.0.1/docs/Prelude.html#v:map
https://hoogle.haskell.org/?hoogle=abs _/}
...
{/_ export function ColorEquation({ color, text }) {
...
<ColorEquation color="OrangeRed" text="s" /> _/}
