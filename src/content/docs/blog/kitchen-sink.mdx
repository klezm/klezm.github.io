...
walkthrough follows [@krishnamurthi2007plai]. The reference list is generated
below, from BibTeX.
...
:::idea
A custom block registered in `astro.config.mjs`. Adding one is a config change,
not a component.
:::

:::proof[By induction]
Custom blocks accept an optional label in square brackets, just like asides.
:::
