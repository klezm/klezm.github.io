...
# excerpt: How to calculate the types in Haskell
# excerpt: Demystifying Type Inference: The Unification Algorithm
# excerpt_ Visualizing Type Unification with Examples in Haskell
# show_sidebar: false
...
$({\color{OrangeRed}s} \; {\color{YellowGreen}t})$
as
$γ({\color{Plum}τ})$
.
Notice that
...
${\color{OrangeRed}s}$
and
${\color{YellowGreen}t_{1 \ldots n}}$
...
.
${\color{Orange}σ_{1 \ldots n}}$
are the types of the arguments passed to the function
${\color{OrangeRed}s_{1 \ldots n}}$
.
${\color{Plum}τ}$
is the type of the return value of
${\color{OrangeRed}s}$
and
${\color{Cyan}ρ_{1 \ldots n}}$
are the types of the arguments passed to
${\color{YellowGreen}t_{1 \ldots n}}$
.

In
$γ({\color{Orange}σ_{1 \ldots n}}) = γ({\color{Cyan}ρ_{1 \ldots n}})$
...
.
Lastly, in
$({\color{OrangeRed}s} \; {\color{#a0d07b}t_1} \ \ldots \ {\color{#75b842}t_n}) :: γ({\color{Plum}τ})$
we define the type of the application
$({\color{OrangeRed}s} \; {\color{#a0d07b}t_1} \ \ldots \ {\color{#75b842}t_n})$
as
$γ({\color{Plum}τ})$
.
...
We find
$γ({\color{Orange}a \rightarrow a \rightarrow b}) = γ({\color{Cyan}c \rightarrow \text{Int} \rightarrow c})$
.
...
<span className="eq-cell">$\emptyset$</span> | <span className="eq-cell">${\color{Orange}a} \doteq {\color{Cyan}b} \\ {\color{Orange}Bool} \doteq {\color{Cyan}[Bool]}$</span> | **Substitution** of $a$ with $b$.
<span className="eq-cell">${\color{Orange}a} \nobreak \mapsto \nobreak {\color{Cyan}b}$</span> | <span className="eq-cell">${\color{Orange}Bool} \doteq {\color{Cyan}[Bool]}$</span> | Error, because ${\color{Orange}Bool}$ is in the domain of ${\color{Cyan}[Bool]}$.
</div>
